...
class MiwebApplicationTests {
	...
	private LoginService loginService;
	 ...
	 usuario.setUsername("Milo");
	 usuario.setPassword("12345");
	 usuario.setNombre("Sari");
	 usuario.setEmail("test@email.com");
	 usuario.setRol(Usuario.Rol.vendedor);
	 // No se establece codigoUsuario, ya que es generado automáticamente en el servicio
	 // No se establece codRecuperacion ni timeLimit, ya que no son necesarios para el registro inicial
	 // No se establece idUsuario, ya que es generado automáticamente por la base de datos
